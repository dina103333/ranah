            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        return `
                            <div class="d-flex">
                                <a class="btn edit" href='/admin/discounts/${data}/edit' class=" px-3"><i class="fas fa-edit" style="color: #2cc3c0;"></i></a>
                                <button  data-url='/admin/discounts/${data}'
