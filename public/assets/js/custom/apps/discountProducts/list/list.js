...
$(document).on('click', '.discount_hold', function (e){
    Swal.fire({
            title: 'هل انت متأكد؟',
            text: "لن تتمكن من التراجع عن هذا!",
            icon: 'warning',
...
var KTRolesList = function () {
    ...
    var initCustomerList = function () {
        ...
        datatable = $(table).DataTable({
            ...
            ajax: {
                url: '/admin/get-productdiscounts',
            },
            columns: [
                { data: 'id' },
                { data: 'product.name' ,className: 'text-center'},
                { data: 'store.name' ,className: 'text-center'},
                { data: 'type' ,className: 'text-center'},
                { data: 'id' ,className: 'text-center'},
                { data: 'id' ,className: 'text-center'},
                { data: 'from_wholesale_total' ,className: 'text-center'},
                { data: 'from_item_total' ,className: 'text-center'},
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        if(row.wholesale_value == null){
                            return `<span>${row.wholesale_ratio} %</span>`
                        }else{
                            return `<span>${row.wholesale_value}</span>`
                        }
                    }
                },
                {
                    ...
                    render: function (data, type, row) {
                        if(row.item_value == null){
                            return `<span>${row.item_ratio} %</span>`
                        }else{
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        return `
                            <div class="d-flex">
                                <a class="btn" href='/admin/discountproducts/${data}/edit' class=" px-3"><i class="fas fa-edit" style="color: #2cc3c0;"></i></a>
                                <button  data-url='/admin/discountproducts/${data}'
    ...
    var initToggleToolbar = () => {
        ...
        $('.delete-all').on('click', function (e) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: "/admin/multiDiscountsDelete",
                        type: 'DELETE',
