            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        return `
                            <a class="btn edit" href='/admin/suppliers/${data}/edit' class=" px-3"><i class="fas fa-edit" style="color: #2cc3c0;"></i></a>
                            <button  data-url='/admin/suppliers/${data}'
