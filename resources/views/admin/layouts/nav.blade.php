                ...
                <div class="topbar d-flex align-items-stretch flex-shrink-0">
                    ...
                    <div class="d-flex align-items-stretch">
                        <div class="topbar-item position-relative px-3 px-lg-5" data-kt-menu-trigger="click"
                            ...
                            <i class="bi bi-app-indicator fs-3"><span class="badge badge-warning navbar-badge number" style="background-color: #e90d28;">{{ unreadedNotfication()}}</span></i>
                        </div>
                                                ...
                                                @if(is_array($notificationData) && isset($notificationData["message"]))
                                                    <div class="d-flex flex-stack py-4">
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="mb-0 me-2">
                                                                <a href="{{route('admin.orders.show',$notificationData["id"])}}"
                                                        ...
                                                        <span class="badge badge-light fs-8">
                                                            <?php
                                                                $timestamp = $notificationData["timestamp"]; // replace with your timestamp
