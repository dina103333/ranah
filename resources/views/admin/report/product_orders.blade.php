...
@section('list')
    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
        ...
        <li class="breadcrumb-item text-muted"> اجمالى الطلبات على المنتجات</li>
    </ul>
@endsection
@section('content')
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_roles_table">
                            <thead>
                                <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="min-w-125px">اجمالى الكميه المطلوبه</th>
                                </tr>
                            </thead>
...
@section('js')
    <script src="/assets/js/custom/apps/productorders/list/list.js"></script>
@endsection
