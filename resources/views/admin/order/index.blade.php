                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end align-items-center d-none" data-kt-role-table-toolbar="selected">
                            ...
                            <button type="button" {{in_array(207, permissions()) ?'' : 'disabled'}} class="btn btn-success" data-kt-role-table-select="delete_selected">تعيين سائق</button>
                        </div>
                    </div>
                </div>
        ...
        $(document).ready(function(event) {
            $.ajax({
                ...
                success: function(response) {
                    if ($.inArray(208, response) !== -1) {
                        $('.show').show();
                    } else {
                        $('.show').hide();
                    }
                    if ($.inArray(201, response) !== -1) {
                        $('.deliver').show();
                    } else {
                        $('.deliver').hide();
                    }
