...
@section('list')
    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
        ...
        <li class="breadcrumb-item text-muted">الكوبونات</li>
    </ul>
@endsection
@section('content')
                    ...
                    <div class="card-toolbar">
                        <div class="d-flex justify-content-end" data-kt-role-table-toolbar="base">
                            @if(in_array(120,permissions()))
                                <a href="{{route('admin.promos.create')}}" type="button" class="btn btn-primary">اضافه كوبون</a>
                            @endif
                        </div>
                        <div class="d-flex justify-content-end align-items-center d-none" data-kt-role-table-toolbar="selected">
                            ...
                            <button type="button" {{in_array(122, permissions()) ?'' : 'disabled'}}  class="btn btn-danger delete-all" data-kt-customer-table-select="delete_selected">حذف</button>
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_roles_table">
                            <thead>
                                <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="min-w-125px">اسم الكوبون</th>
                                    <th class="min-w-125px">قيمه الكوبون</th>
...
@section('js')
<script src="/assets/js/custom/apps/promos/list/list.js"></script>
    <script>
        setTimeout(function() {
            $('.flash').fadeOut('fast');
        }, 3000);
