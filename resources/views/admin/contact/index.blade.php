...
@section('list')
    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
        ...
        <li class="breadcrumb-item text-muted">ارقام التواصل</li>
    </ul>
@endsection
@section('content')
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                            <a href="{{route('admin.contacts.create')}}" type="button" class="btn btn-primary">اضافه رقم</a>
                        </div>
...
@section('js')
<script src="/assets/js/custom/apps/contacts/list/list.js"></script>
    <script>
        setTimeout(function() {
            $('.flash').fadeOut('fast');
        }, 3000);
