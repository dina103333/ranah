                    ...
                    <div class="card-toolbar">
                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                            ...
                            @if(in_array(1,permissions()))
                                <a href="{{route('admin.officials.create')}}" type="button" class="btn btn-primary">اضافه مسؤول</a>
                            @endif
                        </div>
...
{{--                            <button type="button" class="btn btn-danger delete-all" data-kt-customer-table-select="delete_selected">حذف</button>--}}
                            ...
                            <button type="button" {{in_array(4, permissions()) ?'' : 'disabled'}} class="btn btn-danger delete-all" data-kt-customer-table-select="delete_selected">حذف</button>
        ...
        $(document).ready(function(event) {
            $.ajax({
                ...
                success: function(response) {
                    if ($.inArray(3, response) !== -1) {
                        $('.edit').show();
                    } else {
                        $('.edit').hide();
                    }
                    if ($.inArray(4, response) !== -1) {
                        $('.delete').show();
                    } else {
                        $('.delete').hide();
                    }
