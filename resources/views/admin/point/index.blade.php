...
@section('list')
    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
        ...
        <li class="breadcrumb-item text-muted">النقاط</li>
    </ul>
@endsection
@section('content')
                    ...
                    <div class="card-toolbar">
                        <div class="d-flex justify-content-end" data-kt-role-table-toolbar="base">
                            @if(in_array(120,permissions()))
                                <a href="{{route('admin.points.create')}}" type="button" class="btn btn-primary">اضافه نقاط</a>
                            @endif
                        </div>
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_roles_table">
                            <thead>
                                <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="min-w-125px">من قيمه</th>
                                    <th class="min-w-125px">الى قيمه</th>
...
@section('js')
<script src="/assets/js/custom/apps/points/list/list.js"></script>
    <script>
        setTimeout(function() {
            $('.flash').fadeOut('fast');
        }, 3000);
