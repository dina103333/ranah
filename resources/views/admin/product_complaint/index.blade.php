...
@section('title') الشكاوى @endsection
@section('list')
    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
        ...
        <li class="breadcrumb-item text-muted">الشكاوى العامه</li>
    </ul>
@endsection
@section('content')
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_role_table">
                            <thead>
                                <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                   ...
                                   <th class="min-w-125px">الشكوى</th>
                                </tr>
                            </thead>
...
@section('js')
<script src="/assets/js/custom/apps/productcomplaints/list/list.js"></script>
    <script>
        setTimeout(function() {
            $('.flash').fadeOut('fast');
        }, 3000);
