...
{{--                            <button href="{{ route('admin.products.export') }}" type="button" class="btn btn-light-primary me-3" data-bs-toggle="modal" data-bs-target="#kt_customers_export_modal">--}}
...
{{--                                Export--}}
{{--                            </button>--}}
                            <a href="{{route('admin.products.create')}}" type="button" class="btn btn-primary">اضافه منتج</a>
                        </div>
                        <div class="d-flex justify-content-end align-items-center d-none" data-kt-role-table-toolbar="selected">
                            <div class="fw-bolder me-5">
                            <span class="me-2" data-kt-role-table-select="selected_count"></span>المختار</div>
