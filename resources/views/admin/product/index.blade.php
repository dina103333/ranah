                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end align-items-center d-none"
                            ...
                            <button type="button" {{in_array(76, permissions()) ?'' : 'disabled'}}  class="btn btn-danger delete-all" data-kt-customer-table-select="delete_selected">حذف</button>
                        </div>
                    </div>
                </div>
        ...
        $(document).ready(function(event) {
            $.ajax({
                ...
                success: function(response) {
                    if ($.inArray(75, response) !== -1) {
                        $('.edit').show();
                    } else {
                        $('.edit').hide();
                    }
                    if ($.inArray(76, response) !== -1) {
                        $('.delete').show();
                    } else {
                        $('.delete').hide();
                    }
