...
@section('list')
    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
        ...
        <li class="breadcrumb-item text-muted">البائعين</li>
    </ul>
@endsection
@section('content')
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                            ...
                            @if(in_array(188,permissions()))
                                <a href="{{route('admin.sellers.create')}}" type="button" class="btn btn-primary">اضافه بائع</a>
                            @endif
                        </div>
                        <div class="d-flex justify-content-end align-items-center d-none" data-kt-customer-table-toolbar="selected">
                            <div class="fw-bolder me-5">
                            <span class="me-2" data-kt-customer-table-select="selected_count"></span>قيد الاختيار</div>
                            <button type="button" {{in_array(190, permissions()) ?'' : 'disabled'}} class="btn btn-danger delete-all" data-kt-customer-table-select="delete_selected">حذف</button>
                        </div>
                    </div>
                </div>
        ...
        $(document).ready(function(event) {
            $.ajax({
                ...
                success: function(response) {
                    if ($.inArray(189, response) !== -1) {
                        $('.edit').show();
                    } else {
                        $('.edit').hide();
                    }
                    if ($.inArray(190, response) !== -1) {
                        $('.delete').show();
                    } else {
                        $('.delete').hide();
                    }
