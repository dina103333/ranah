                    ...
                    <div class="card-toolbar">
                        <div class="d-flex justify-content-end" data-kt-role-table-toolbar="base">
                            ...
                            @if(in_array(9,permissions()))
                                <a href="{{route('admin.companies.create')}}" type="button" class="btn btn-primary">اضافه شركه</a>
                            @endif
                        </div>
                        <div class="d-flex justify-content-end align-items-center d-none" data-kt-role-table-toolbar="selected">
                            ...
                            <button type="button" {{in_array(12, permissions()) ?'' : 'disabled'}} class="btn btn-danger" data-kt-role-table-select="delete_selected">حذف</button>
        ...
        $(document).ready(function(event) {
            $.ajax({
                ...
                success: function(response) {
                    if ($.inArray(11, response) !== -1) {
                        $('.edit').show();
                    } else {
                        $('.edit').hide();
                    }
                    if ($.inArray(12, response) !== -1) {
                        $('.delete').show();
                    } else {
                        $('.delete').hide();
                    }
