@extends('layouts.app')
@section('title') @lang('data.Edit City')@endsection
@section('back_button')
        ...
        <div class="col">
            <div class="card shadow">
                <div class="card-header border-0">
                    <h3 class="mb-0">@lang('data.Edit City')</h3>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.update_cities',$city->id) }}" method="post" enctype="multipart/form-data">
